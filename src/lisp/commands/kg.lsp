...
;;
;; УГОЛ ОПРОВЕРГНУТ ПРЯМО: вершину с изломом 22,3 град образец не подписал,
;; а с 18,0 подписал - разделить их углом невозможно ни при каком пороге.
;; По отклонению вилка (0,219 ; 0,258], и 0,25 м ложится ровно: ноль
;; несовпадений на всех десяти.
;;
