...
Этот файл — точка входа для не-Claude AI-инструментов (Cursor, Codex, Gemini, Copilot и др.).

**Канонический контракт проекта — `CLAUDE.md`. Содержание полностью применимо к любой AI.**
